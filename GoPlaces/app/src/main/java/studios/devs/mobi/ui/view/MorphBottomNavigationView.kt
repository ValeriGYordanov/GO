 ...
 */
class MorphBottomNavigationView : BottomNavigationView, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs,
        ...
        context.theme?.resolveAttribute(R.color.colorPrimary, typedValue, true)
