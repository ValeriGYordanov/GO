...
public class CurvedBottomNavigtionView extends BottomNavigationView {
    private Path mPath;
    ...
    public CurvedBottomNavigtionView(Context context) {
        super(context);
        init();
    }

    public CurvedBottomNavigtionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CurvedBottomNavigtionView(Context context, AttributeSet attrs, int defStyleAttr) {
